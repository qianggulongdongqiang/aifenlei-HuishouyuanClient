...
import com.arcfun.aifenx.zxing.client.PlanarYUVLuminanceSource;
...
public final class CameraManager {
    ...
    public Rect getFramingRect() {
        if (framingRect == null) {
            ...
            framingRect = new Rect(leftOffset, topOffset, leftOffset + width,
                    topOffset + height);
            LogUtils.d(TAG, "manual " + framingRect + "[" + screenResolution.x
                    + "," + screenResolution.y + "]");
        }
        return framingRect;
    }
    ...
    public Rect getFramingRectInPreview() {
        if (framingRectInPreview == null) {
            ...
            LogUtils.d(TAG, "[" + cameraResolution.x + "," + cameraResolution.y + "]" + rect);
