...
public class HttpRequest {
    ...
    public static final String SCORE_SEND_SMS_CODE = "api/score/sendSmsCode.html";
    public static final String SCORE_ADD_ORDER = "api/score/addOrder.html";
    public static final String SCORE_CONSUME = "api/score/consume.html";
    public static final String SCORE_QUERY = "api/user/getScoreByMobile.html";
    ...
    public static final String GET_PRE_ORDER= "api/user/getPreOrder.html";
